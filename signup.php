...
<div class="container-fluid">
	<nav class="navbar navbar-expand-lg navbar-light bg-light" style="border-radius:15px; padding: 15px 10px; border-style: solid; border-color: black">
		...
		<div class = "row" style="">
			...
			<h4 style="color:black;">Step 1: Enter your name and choose a password</h4><br><br>
			...
			<input type="text" style="padding: 5px; border-style:solid;" name="lastname" placeholder="Last Name" autofocus="true"/><br><br>
        		...
        		<input type="submit" style="padding: 5px 10px; color: white; background-color:#8c5020; border-radius:10px; border-style:solid; border-color:black;" value="Confirm" name="submit" class="login-button"/><br><br>
        		<p class="link" style="color:#8c5020;"><a style="color:#8c5020;" href='login.php'>Sign In</a></p>
  			</form>
		</div>
		</div>
</body>
